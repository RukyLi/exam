<template>
  <div class="service-user-container">
    ...
    <el-row style="margin-top:16px">
      <el-col :span="4">服务对象总数：{{ serviceObj.svc_obj_amount }}人 </el-col>
      <el-col :span="4"> 男性：{{ serviceObj.male_amount }}人
        占{{ ((serviceObj.male_amount/serviceObj.svc_obj_amount)*100).toFixed(2) }}%
      </el-col>
      <el-col :span="4"> 女性：{{ serviceObj.female_amount }}人
        占{{ ((serviceObj.female_amount/serviceObj.svc_obj_amount)*100).toFixed(2) }}%
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    async getCommunityList() {
      ...
      const communityList = result.data.community_list || []
    ...
    async getSudistrictLit(communityId) {
      ...
      const subdistrictList = result.data.subdistrict_list || []
